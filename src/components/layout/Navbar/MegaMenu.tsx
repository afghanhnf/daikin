        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              onClick={onClose}
              className={cn(
                "flex items-center gap-3.5 px-3 py-2.5 rounded-xl group transition-colors duration-150",
                isActive ? "bg-daikin-blue-50" : "hover:bg-gray-50"
              )}
            >
              {Icon && (
                <div className={cn(
                  "w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-200",
                  isActive ? "bg-daikin-blue" : bg
                )}>
                  <Icon className={cn(
                    "w-4 h-4 transition-colors duration-200",
                    isActive ? "text-white" : cl
                  )} />
                </div>
              )}
              <div className="min-w-0">
              ...
              <ArrowRight className={cn(
                "w-3.5 h-3.5 ml-auto flex-shrink-0 transition-all duration-200",
                isActive 
