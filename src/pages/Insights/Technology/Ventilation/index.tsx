        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
          ...
          <FadeInUp>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md text-xs font-semibold uppercase tracking-wider mb-4 text-sky-100 border border-white/10">
              <Wind className="w-4 h-4 text-[#0097E0] bg-white rounded-full p-0.5" /> Daikin Air Ventilation Expert Guide
            </div>

            <h1 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight leading-tight max-w-4xl">
              METODE EXPERT VENTILASI DAIKIN
            </h1>

            <p className="text-white/90 text-lg md:text-xl font-bold max-w-3xl leading-relaxed text-sky-100">
              Tanya Jawab Ahli: Sirkulasi Udara Segar & Sistem Mekanis untuk Hunian dan Ruang Komersial
            </p>
          </FadeInUp>
        </div>
      </div>
