...
import { 
  ChevronRight, ChevronLeft, ArrowRight, Award, Sparkles, 
...
const GALLERY_ITEMS = [
  {
    id: 1,
    title: 'Pilihan Unit Indoor Wall Mounted & Ducted',
    subtitle: 'Kombinasi fleksibel unit Wall Mounted CTKM dan Ducted (Low & Middle Static) sesuai estetika interior setiap ruangan.'
  },
  {
    id: 2,
    title: 'Unit Outdoor Super Multi NX R32',
    subtitle: 'Satu unit outdoor tunggal efisien untuk mendinginkan seluruh rumah dengan penghematan area balkon & konsumsi listrik.'
  },
  {
    id: 3,
    title: 'Fleksibilitas Pembagian Kapasitas Otomatis',
    subtitle: 'Sistem cerdas membagi kapasitas operasi secara efektif sesuai kebutuhan pendinginan di setiap ruangan.'
  }
]

const SUPER_MULTI_NX_PRODUCTS: MultiNXProductItem[] = [
  {
    id: 'wall-mounted-ctkm',
    type: 'Indoor Unit',
    name: 'Wall Mounted (CTKM)',
    description: 'Unit indoor tipe wall mounted efisiensi tinggi dengan desain ramping, hembusan Coanda Airflow, dan pengoperasian sangat senyap.',
    specs: {
      'Tipe Unit': 'Wall Mounted High Inverter',
      'Airflow': 'Coanda Airflow 3D',
      'Fitur Utama': 'Intelligent Eye, Eco Mode, Quiet 19dB'
    },
    app: 'Kamar Tidur & Ruang Tamu',
    badge: 'Coanda Airflow'
  },
  {
    id: 'low-static-duct',
    type: 'Indoor Unit',
    name: 'Low Static Pressure Duct Type',
    description: 'Unit ducted tersembunyi berprofil ultra tipis untuk plafon rendah dengan tingkat bising minimal dan integrasi interior sempurna.',
    specs: {
      'Profil': 'Ultra Slim Profile (Tinggi 200mm)',
      'Tekanan Statis': 'Low Static Pressure (up to 30 Pa)',
      'Fitur Utama': 'Built-in Drain Pump, Airflow Hening'
    },
    app: 'Kamar Tidur & Ruang Kerja Minimalis',
    badge: 'Ultra Slim Duct'
  },
  {
    id: 'middle-static-duct',
    type: 'Indoor Unit',
    name: 'Middle Static Pressure Duct Type',
    description: 'Unit ducted bertekanan statis sedang untuk distribusi udara pendingin ke ruangan yang lebih luas dengan fleksibilitas saluran ducting.',
    specs: {
      'Tekanan Statis': 'Middle Static Pressure (up to 100 Pa)',
      'Cakupan Ruang': 'Ruangan Luas & Memanjang',
      'Fitur Utama': 'Fleksibilitas Ducting, Inverter Airflow'
    },
    app: 'Ruang Keluarga & Penthouse',
    badge: 'Medium Static'
  },
  {
    id: 'unit-outdoor',
    type: 'Outdoor Unit',
    name: 'Unit Outdoor Super Multi NX',
    description: 'Unit outdoor tunggal hemat energi dengan teknologi Full DC Inverter R32 yang mampu melayani hingga 5 unit indoor sekaligus.',
    specs: {
      'Refrigerant': 'R-32 Eco Friendly',
      'Kompresor': 'DC Swing Inverter Compressor',
      'Fitur Utama': 'Capacity Sharing, Anti-Corrosion Hydrophilic Fin'
    },
    app: 'Area Balkon / Atap Perumahan Premium',
    badge: 'R32 Inverter Outdoor'
  }
]

export default function SuperMultiNX() {
  const [selectedProduct, setSelectedProduct] = useState<MultiNXProductItem | null>(null)
  ...
  return (
    <PageTransition>
      <PageMeta 
        title="Super Multi NX R32 - AC Perumahan Premium Daikin" 
        description="Solusi AC Multi Split Super Multi NX R32 hemat tempat dan hemat listrik untuk hunian perumahan premium."
        canonical="/products/residential/super-multi-nx" 
      />
        ...
        <div className="relative z-20 w-full px-4 md:px-8 lg:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            <nav className="flex items-center space-x-2 text-white/80 mb-6 text-sm font-medium tracking-wide">
              <Link to="/" className="hover:text-white transition-colors">Semua Produk</Link>
              <ChevronRight className="w-4 h-4" />
              <Link to="/products/residential" className="hover:text-white transition-colors">AC Perumahan Premium</Link>
              <ChevronRight className="w-4 h-4" />
              <span className="text-white font-semibold">Super Multi NX R32</span>
            </nav>
            ...
            <FadeInUp>
              ...
              <p className="text-white/95 text-base md:text-lg font-light leading-relaxed max-w-xl mb-8">
                Tipe multi split membagi kapasitas operasi antara unit dalam ruangan sesuai kebutuhan, memungkinkan sistem dengan kapasitas yang lebih kecil untuk secara efektif menyejukkan seluruh rumah Anda. Ini juga membantu mengurangi konsumsi listrik.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  onClick={() => setSelectedProduct(SUPER_MULTI_NX_PRODUCTS[0])}
          ...
          <FadeInUp delay={0.2} className="lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg aspect-[4/3]">
              ...
              <div className="relative z-10 w-full h-full bg-white/20 rounded-2xl border border-white/30 backdrop-blur-sm overflow-hidden flex flex-col items-center justify-center p-6 text-center text-white">
                ...
                <span className="text-xs opacity-60 mt-1">(Super Multi NX R32 Indoor & Outdoor Unit System)</span>
              </div>
            </div>
          </FadeInUp>
        </div>
      ...
      <div className="py-5 bg-white border-b border-slate-100 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          <div className="flex items-center gap-3">
            <span className="font-extrabold text-daikin-blue text-base md:text-lg tracking-tight uppercase">SUPER MULTI NX R32</span>
            <span className="text-slate-300 font-light">|</span>
            <span className="font-semibold text-slate-500 text-xs md:text-sm tracking-wider uppercase">AC Perumahan Premium</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          <FadeInUp className="text-center max-w-3xl mx-auto mb-10 space-y-2">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-charcoal">
              Galeri Foto <span className="text-daikin-blue">Super Multi NX R32</span>
            </h2>
            <p className="text-gray-500 text-xs md:text-sm">
              Geser untuk melihat detail unit indoor wall mounted CTKM, tipe ducting, dan unit outdoor ringkas.
            </p>
          </FadeInUp>
      ...
      {/* Product Units Grid (4 Items extracted from layout screenshot) */}
      <div className="py-20 bg-gray-50 relative">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
          
          <FadeInUp className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4">
              Pilihan Unit Super Multi NX R32
            </h2>
            <p className="text-gray-600 text-sm md:text-base">
              Pilih variasi unit indoor dan outdoor yang sesuai dengan estetika serta kebutuhan kapasitas pendinginan rumah Anda.
            </p>
          </FadeInUp>

          {/* 4 Cards Grid Layout */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch mb-12">
            {SUPER_MULTI_NX_PRODUCTS.map((product, idx) => (
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-200/80 shadow-sm hover:shadow-xl hover:border-daikin-blue/50 transition-all duration-300 h-full flex flex-col justify-between group">
                  ...
                  <div>
                    ...
                    <div className="text-center px-2">
                      <h3 className="text-sm font-bold text-daikin-blue min-h-[44px] flex items-center justify-center leading-snug mb-3">
                        {product.name}
                      </h3>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full mt-4 bg-[#0097e6] text-white py-3 px-6 rounded-xl font-bold text-xs hover:bg-[#0080cb] transition-colors shadow-sm text-center"
                  >
                    Lihat Produk
                  </button>
          ...
          {/* Middle Button Linking to VRV Home Series (Extracted from layout screenshot) */}
          <FadeInUp className="text-center mt-4 mb-6">
            <Link
              to="/products/residential/vrv-home"
              className="inline-flex items-center gap-2 bg-[#0097e6] text-white py-3.5 px-8 rounded-xl font-bold text-sm hover:bg-[#0080cb] transition-all shadow-md"
            >
              Lihat AC VRV Home Series
            </Link>
          </FadeInUp>
      ...
      <div className="py-16 bg-gradient-to-r from-[#0080cb] to-[#00b0f0] text-white text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h3 className="text-2xl md:text-3xl font-bold mb-4">
            Butuh Rekomendasi Unit Super Multi NX R32 untuk Rumah Anda?
          </h3>
          <p className="text-white/90 text-sm md:text-base mb-8 max-w-xl mx-auto">
            Konsultasikan ukuran ruangan dan kapasitas unit dengan dealer & konsultan resmi Daikin.
          </p>
          <Link 
            to="/services/proshop" 
            ...
            <FadeInUp delay={0.3}>
              <Link to="/products/residential/vrv-home" className="group flex items-center p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md hover:border-daikin-blue transition-all duration-300">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-gray-500 text-xs">AC Central Hunian Mewah</p>
                </div>
                <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-daikin-blue group-hover:translate-x-1 transition-all shrink-0 ml-2" />
              </Link>
            </FadeInUp>
